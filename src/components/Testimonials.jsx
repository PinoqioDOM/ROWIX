  ...
  return ( 
    <div className='mt-6 rounded-2xl border border-[#CE7D63]'>
      <div className='border border-[#2A2A2A] rounded-2xl p-8'>
        <div className='flex items-center justify-between mb-8 p-6 border-b border-dotted border-[#2A2A2A] bg-[#1A1A1A] rounded-2xl'>
        ...
        <div className='grid grid-cols-4 gap-6'>
          {testimonials.map(testimonial => (
            <div key={testimonial.id} className='bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl p-6 flex flex-col justify-between'>
              <div>
              ...
              <div className='bg-[#141414] rounded-lg p-4 flex items-center justify-between'>
                <div className='flex items-center gap-3'>
                  <img src={testimonial.img} alt={testimonial.name} className='w-10 h-10 rounded-full bg-[#CE7D63] object-cover' />
                  <div>
                ...
                <div className='w-8 h-8 rounded-full border border-gray-600 flex items-center justify-center hover:border-gray-400 hover:bg-[#CE7D63] transition-colors cursor-pointer'>
